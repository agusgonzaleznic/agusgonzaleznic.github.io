...
const timeline = [
  {
    ...
    achievement: "Led migration to multi-account AWS, reduced costs 40%, achieved 99.99% uptime",
  },
  {
    period: "2020-2022",
    company: "Riot Games",
    role: "Staff DevOps & Security Engineer",
    achievement: "Built serverless threat detection; scaled to millions of daily events",
  },
  {
    period: "2018-2020",
  ...
  {
    period: "2014-2018",
    company: "Naranja (FinTech)",
    role: "Senior Infrastructure & Security",
    achievement: "Core banking system delivery; PCI-DSS compliance and security hardening",
  },
];
