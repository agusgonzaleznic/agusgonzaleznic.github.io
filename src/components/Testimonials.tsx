        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {engagements.map((engagement, index) => (
              ...
              >
                <div className="mb-6">
                  <p className="font-medium text-foreground">{i18n._(engagement.role)}</p>
                  <p className="text-sm text-muted-foreground">{i18n._(engagement.context)}</p>
                </div>

                <p className="text-foreground leading-relaxed">
                  {i18n._(engagement.sketch)}
                </p>
              </Card>
            ))}
          </div>
