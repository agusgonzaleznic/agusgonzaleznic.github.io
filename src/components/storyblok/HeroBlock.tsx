...
export const HeroBlock = ({ blok }: HeroBlockProps) => {
  const handlePrimaryCTA = () => {
    if (blok.cta_url) {
      if (blok.cta_url.startsWith("http")) {
        window.open(blok.cta_url, "_blank");
      } else {
        window.location.href = blok.cta_url;
      }
    }
  };
  ...
  const handleSecondaryCTA = () => {
    if (blok.secondary_cta_url) {
      if (blok.secondary_cta_url.startsWith("#")) {
        ...
        window.location.href = blok.secondary_cta_url;
      }
    }
  };
  ...
  return (
    <section
      ...
      id="home"
      className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-b from-background to-secondary/30"
    >
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div className="space-y-8 animate-fade-in-up">
              ...
              <div className="flex flex-col sm:flex-row gap-4 pt-4">
                ...
                {blok.secondary_cta_text && blok.secondary_cta_url && (
                  <Button
                    size="lg"
                    variant="outline"
              ...
              <div className="pt-8 border-t border-border">
                <p className="text-sm text-muted-foreground mb-3">Hi! I'm {blok.name}</p>
              </div>
            </div>
              ...
              <div className="relative aspect-square max-w-lg mx-auto">
                ...
                <div className="relative rounded-3xl overflow-hidden shadow-2xl hover-lift">
                  <img
                    ...
                    alt={blok.profile_image.alt || `${blok.name} - ${blok.title}`}
